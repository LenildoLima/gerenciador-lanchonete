                ...
                <tr key={m.id} className="hover:bg-muted/10 transition-colors">
                  <td className="p-4">
                    <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider ${
                      m.tipo === 'suprimento' ? "bg-green-100 text-green-700 border border-green-200" : "bg-red-100 text-red-700 border border-red-200"
                    }`}>
              ...
              <div className="space-y-4">
                ...
                {valorFechamento > 0 && (
                  <div className={`p-4 rounded-2xl flex items-center justify-between border-2 transition-all ${
                    valorFechamento === saldoEsperado ? "bg-green-50 border-green-200 text-green-700" :
